...
export default function ModCalcScreen() {
  ...
  const restoreHistory = (h: HEntry) => {
    setExpr(h.expr);
    setResult(h.error ? null : h.result);
    ...
    <SafeAreaView style={s.root}>
      ...
      >
        ...
        <View style={s.display}>
          ...
          <View style={s.tRow}>
              ...
              <View style={s.tPresets}>
                ...
                >
                  <Text
                    style={[
                      s.tBtnTxt,
                      modT === 0 && { color: "#06b6d4", fontWeight: "700" },
                    ]}
                  >
                    ∞ free
                  </Text>
                ...
                {[2, 7, 10, 26, 27, 29].map((t) => (
                  <TouchableOpacity
                    key={t}
                    style={[s.tBtn, modT === t && s.tBtnActive]}
                    onPress={() => {
                      setModT(t);
                      setModInput(String(t));
                    }}
                  >
                    <Text style={[s.tBtnTxt, modT === t && { color: C.lime }]}>
                      T={t}
                    </Text>
                  </TouchableOpacity>
                ))}
            ...
            <View style={s.modInputWrap}>
              ...
              <TextInput
                style={[
                  s.modInput,
                  modT === 0 && { borderColor: C.cyan, color: C.cyan },
                ]}
          ...
          {/* Expression small */}
          {displayExpr ? (
            <Text style={s.exprSmall} numberOfLines={2}>
              {displayExpr}
            </Text>
          ) : null}
          ...
          {/* Big number */}
          {error ? (
            <Text style={s.errorTxt} numberOfLines={3}>
              {error}
            </Text>
          ) : (
            <Text style={s.bigNum} numberOfLines={1} adjustsFontSizeToFit>
              {displayBig}
            </Text>
          )}
          ...
          <View style={s.histPanel}>
            ...
            {history.length === 0 ? (
              ...
              history.map((h) => (
                ...
                >
                  <Text style={s.histExpr} numberOfLines={1}>
                    {h.expr}
                  </Text>
        ...
        <View style={s.refGrid}>
          {[
            ...
            ["a ^ b", "Modular exponent"],
            ["a mod b", "Plain remainder"],
            ["inv(a)", "Modular inverse"],
            ["gcd(a,b)", "Greatest common div"],
          ].map(([fn, desc]) => (
...
const s = StyleSheet.create({
  ...
  scroll: { flex: 1 },
  display: {
    backgroundColor: "rgba(10, 8, 24, 0.68)",
    borderWidth: 1,
  ...
  histToggle: {
    ...
    borderWidth: 1,
    borderColor: C.border,
    backgroundColor: "rgba(26, 24, 53, 0.68)",
    alignItems: "center",
  },
  ...
  histItem: {
    ...
    borderBottomWidth: 1,
    borderColor: C.border,
    backgroundColor: "rgba(19, 17, 42, 0.68)",
  },
  histExpr: {
    fontFamily: F.mono,
    fontSize: 11,
  ...
  refCard: {
    width: "47%",
    backgroundColor: "rgba(26, 24, 53, 0.66)",
    borderRadius: 9,
    borderWidth: 1,
    borderColor: C.border,
    padding: 10,
